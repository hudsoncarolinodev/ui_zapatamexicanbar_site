...
BK = function () {
    ...
    return {
        ...
        templates: {
            ...
            'product-detail': '<section id="product-dropdown" data-product-id="{{id}}" class="col-xs-12 dropdown"><div class="wrapper"><div class="container-fluid product-hero"><div class="row content clearfix"><a class="close" href="#" data-ga="send,event,product,click,detailsClose"><i class="fa fa-times-circle" aria-hidden="true"></i></a><hgroup class="col-sm-6 text-left title-group"><h1 class="title">{{{title}}}</h1><h2 class="subtitle">{{{subtitle}}}</h2></hgroup><div class="image col-xs-12 col-sm-6 text-right"><img src="{{{image}}}" /></div><div class="description col-sm-6 text-left hidden-xs">{{{description}}}</div><div class="action col-xs-12 col-sm-6 text-center"><a href="{{url}}" class="bk-btn bk-btn-orange" data-ga="send,event,product,click,detailsCTA">' + Drupal.t('Info &amp; Nutrition') + '<i class="icon icon_fork-white"></i></a></div></div></div></div></section>',
